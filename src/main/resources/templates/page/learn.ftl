                ...
                <div class="col-md-3">
                    <table class="table table-bordered table-striped">
                        ...
                        <#list stageList as stage>
                            <tr>
                                <td>
                                    <a href="/graduation/hobby/learn?sid=${stage.id}">${stage.name}</a>
                                </td>
                            </tr>
                        </#list>
                    </table>
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <#-- <a href="${content.note}">查看笔记</a>-->
                                        笔记已保存在博客页面
                                    <#else>
                                        <a href="/graduation/blog/addTopic?id=${content.id}">填写笔记</a>
                                    </#if>
                                </th>
                                <th>
                                    <a href="/graduation/content/complete?id=${content.id}">点击完成</a>
                                </th>
                            </tr>
