...
<div class="container-fluid">
    <div id="tooBar" style="padding: 10px 0px 0px 10px;">
        ...
        <form action="Section_list.action" method="post" class="form-search" style="display: inline;">
            &nbsp;小板块名称：
            <input name="s_section.name" value="${s_section.name }" type="text"
                   class="input-medium search-query" placeholder="输入小板块名称..."/>
            &nbsp;所属大板块：
                        ...
                        <c:forEach items="${sectionList }" var="section">
                            <tr>
                                ...
                                <td style="text-align: center;vertical-align: middle;width: 110px;">
                                    <img style="width: 100px;" src='admin/${section.logo }'></img>
                                </td>
