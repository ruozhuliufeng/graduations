                        ...
                        <tr>
                            <td>
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <img alt="" src="${reply.user.face}" style="width: 100px;height: 100px;">
                                    </c:otherwise>
                                </c:choose>
                    ...
                    <form id="replyForm" class="form-horizontal" style="margin-top: 10px;">
                        <table style="width: 100%;" cellpadding="10px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <Button class="btn btn-primary " data-dismiss="modal" aria-hidden="true" type="button"
                                            onclick="javascript:saveReply()">提交</Button>
                                    <font id="error"></font>
                                </td>
                            </tr>
                        </table>
