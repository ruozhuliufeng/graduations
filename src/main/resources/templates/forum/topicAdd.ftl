...
<div style="width: 1200px; margin: 0 auto;">
    <table border="0" width="100%" cellspacing="0" cellpadding="0" style="margin-top: 8px;width: 1400px;" align="center">
        ...
        <tr>
            ...
            <td>
                <form class="form-horizontal" style="margin-top: 10px;"
                      action="Topic_save.action" method="post" onsubmit="return checkForm()">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id="section" name="topic.section.id" style="width: 400px;">
